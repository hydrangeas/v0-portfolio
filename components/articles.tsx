  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2 text-center">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">技術記事</h2>
        <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">Zenn、Qiitaで公開している技術記事</p>
      </div>
                ...
                <CardHeader className="space-y-1">
                  <div className="flex items-center justify-between">
                    <Badge
                      variant="secondary"
                      className={`${
                        article.platform === "zenn" ? "bg-[#3EA8FF] text-white" : "bg-[#55C500] text-white"
                      }`}
                    >
                      {article.platform === "zenn" ? "Zenn" : "Qiita"}
                    </Badge>
